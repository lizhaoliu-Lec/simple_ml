...
def seq_cnn_mnist():
    ...
    model.add(Conv2d(2, 16, stride=2, padding=0, activation='relu'))
    model.add(Conv2d(2, 32, stride=2, padding=0, activation='relu'))
    model.add(Conv2d(4, 64, stride=1, padding=0, activation='relu'))
    model.add(Flatten())
    model.add(Softmax(label_size))
